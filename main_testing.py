...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        # file_menu.addAction(self.actionSaveAs)
    ...
    def save_as(self):
        ...
        file_path, _ = QFileDialog.getSaveFileName(self, "Save File", "", "Images (*.png *.xpm *.jpg)")
        
        if file_path:
            try:
                # Save the pixmap or any other data you want to save
    ...
    def grayscale_lightness(self):
        outputFile = MenuColor.rgb_to_grayscale_lightness(self.imageInputPath)
        self.showToOutput(outputFile)
